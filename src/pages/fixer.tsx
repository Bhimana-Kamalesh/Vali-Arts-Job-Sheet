                        ...
                        {myJob.delivery_mode === "onsite" && (
                            <div style={{marginTop: '20px', display:'flex', gap:'12px'}}>
                                ...
                                <div>
                                    ...
                                    <div style={{color: '#64748b'}}>{myJob.area || myJob.area || "No address"}</div>
                                    {(myJob.area || myJob.area) && (
                                        <a
                                            href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(myJob.area || myJob.area || "")}`}
